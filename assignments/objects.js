...
function talk(Kennan){

	return("Hello, my name is " + Kennan["name"])

}
console.log(talk(intern2))
...
function parentspeak(Susan){

	return("Hello, im "+Susan['name']"!")

}
function childspeak(George){

	return("Hello, im "+George['name']"!")

	
}

function grandchildspeak(Sam){

	return("Hello, im "+Sam['name']"!")
